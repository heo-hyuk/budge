    ...
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5 shadow-sm space-y-4">
          ...
          {/* 분류 */}
          <div>
            <label className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-1">분류</label>
              ...
              {categories.map((c) => (
                <button
                  ...
                  className={`min-h-8 rounded-full px-3 text-sm font-semibold transition-colors ${
                    form.category === c ? 'bg-coral-50 dark:bg-coral-900/30 text-coral-800 dark:text-coral-200' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-700'
                  }`}
                >
                  {c}
                </button>
          ...
          {/* 결제 방법 */}
          <div>
            <label className="block text-sm font-semibold text-neutral-700 dark:text-neutral-300 mb-1">결제 방법</label>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                onClick={() => setForm((f) => ({ ...f, payment_method: '현금' }))}
                className={`min-h-8 rounded-full px-3 text-sm font-semibold transition-colors ${
                  form.payment_method === '현금' ? 'bg-coral-400 text-white' : 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 hover:bg-neutral-200 dark:hover:bg-neutral-700'
                }`}
              >
                현금
              </button>
